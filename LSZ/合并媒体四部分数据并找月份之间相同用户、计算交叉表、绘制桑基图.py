...
def find_common_user_between_two_months_by_media():
    ...
    for date1, date2 in zip(date1s, date2s):
        path1 = rf'F:\Experimental Results\Average_Bias_Rating\media_average_rating\total_url-rating\user_bias_scores_by_month\user_bias_scores_{date1}.csv'
        path2 = rf'F:\Experimental Results\Average_Bias_Rating\media_average_rating\total_url-rating\user_bias_scores_by_month\user_bias_scores_{date2}.csv'
        output_path = rf'F:\Experimental Results\Average_Bias_Rating\media_average_rating\total_url-rating\sankey_plot\every_month\common_user_bias\common_user_bias_{date1}_to_{date2}.csv'
...
def Construct_matrix_data_for_drawing_Sankey_diagrams_by_media():
    ...
    for date1, date2 in zip(date1s, date2s):
        # 载入数据
        file_path = rf'F:\Experimental Results\Average_Bias_Rating\media_average_rating\total_url-rating\sankey_plot\every_month\common_user_bias\common_user_bias_{date1}_to_{date2}.csv'
        output_transition_matrix_path = rf"F:\Experimental Results\Average_Bias_Rating\media_average_rating\total_url-rating\sankey_plot\every_month\cross_table\transitions_sankey_{date1}_to_{date2}.csv"
...
def 检查交叉表里的value数据之和是否和两个月份之间的相同用户数量相同():
    # 文件夹路径
    folder_path = r"F:\Experimental Results\Average_Bias_Rating\media_average_rating\total_url-rating\sankey_plot\every_month\cross_table"
...
def plot_monthly_sankey_by_meida():
    ...
    date2s = ['2020_01', '2020_02', '2020_03', '2020_04', '2020_05', '2020_06', '2020_07', '2020_08', '2020_09',
              '2020_10', '2020_11', '2020_12', '2021_01', '2021_02']
    for date1, date2 in zip(date1s, date2s):
        csv_file = rf'F:\Experimental Results\Average_Bias_Rating\media_average_rating\total_url-rating\sankey_plot\every_month\cross_table\transitions_sankey_{date1}_to_{date2}.csv'
...
def change_name():
    ...
    folder_path = r'F:\Experimental Results\Average_Bias_Rating\media_average_rating\total_url-rating\sankey_plot\every_month\Sankey_plot'
