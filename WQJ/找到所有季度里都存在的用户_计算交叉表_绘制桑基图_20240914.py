...
def 找到所有季度里都存在的用户():
    # 设置文件目录路径
    dir_path = r'F:\Experimental Results\Average_Bias_Rating\media_average_rating\external_url-rating'
    ...
    # 将结果保存到新的CSV文件中
    output_file = os.path.join(dir_path, 'merged_user_average_bias_points.csv')
