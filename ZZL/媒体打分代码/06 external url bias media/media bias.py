...
def user_bias_by_external_url():
    ...
    for month in months:
        ...
        # folder_path = f"F:\\three_parts_output\\single_url\\test\\output_{month}"
        ...
        # 保存为CSV文件
        output_path = f"I:\\four\\Experimental Results\\Average_Bias_Rating\\media_average_rating\\external_url-rating\\user_bias_scores_{month}.csv"
