...
def wash_data_media_url():
    ...
    # 读取 CSV 文件
    file_path = 'F:\\fianl data\\media bias\\media-bias-final-url.csv'  # 将此处替换为你的文件路径
    df = pd.read_csv(file_path, dtype=str, header=0, index_col=False)
