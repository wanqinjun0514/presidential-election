...
def batch_remove_dup_user_id(num_file, num_xlsx):
    record_txt = f'H:\\retweet_user_id\\republican_remove_dup\\{num_file}\\{num_file}.txt'

    for i in range(0, num_xlsx + 1):  # 生成0_output.xlsx-num_output.xslx
        input_xlsx = f"H:\\retweet_user_id\\republican\\{num_file}\\{num_file}-{i}.xlsx"
        output_xlsx = f'H:\\retweet_user_id\\republican_remove_dup\\{num_file}\\{num_file}-{i}.xlsx'
        print("-----------------------------------------------------------------------------------------------------")
        print(input_xlsx)
        print(output_xlsx)
        print(record_txt)
...
if __name__ == "__main__":
    ...
    for i in range(3, 18):
        ...
        print("=====================================================================================================")
        output_folder = f'H:\\retweet_user_id\\republican_remove_dup\\{i}'
        # 检查文件夹是否存在
        ...
        batch_remove_dup_user_id(i, file_num[i])
