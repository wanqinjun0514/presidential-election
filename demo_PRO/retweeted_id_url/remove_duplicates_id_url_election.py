...
def batch_remove_dup(num_xlsx):
    record_txt = f'H:\\retweeted_id - url\\electionday_remove_dup\\electionday.txt'

    for i in range(0, num_xlsx + 1):  # 生成0_output.xlsx-num_output.xslx
        input_xlsx = f'H:\\retweeted_id - url\\electionday\\{i}.xlsx'
        output_xlsx = f'H:\\retweeted_id - url\\electionday_remove_dup\\{i}.xlsx'
        print("-----------------------------------------------------------------------------------------------------")
        print(input_xlsx)
        print(output_xlsx)
        print(record_txt)
...
if __name__ == "__main__":
    ...
    print("=====================================================================================================")
    output_folder = f'H:\\retweeted_id - url\\electionday_remove_dup'
    # 检查文件夹是否存在
