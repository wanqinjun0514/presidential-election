...
def batch_extract_relationship(num_xlsx):
    record_txt = f'H:\\tranforming_relationship\\electionday_count\\electionday.txt'

    for i in range(0, num_xlsx + 1):  # 生成0_output.xlsx-num_output.xslx
        input_xlsx = f"H:\\tranforming_relationship\\electionday\\{i}.xlsx"
        output_xlsx = f'H:\\tranforming_relationship\\electionday_count\\{i}.xlsx'
        print("-----------------------------------------------------------------------------------------------------")
        print(input_xlsx)
        print(output_xlsx)
        print(record_txt)
        ...
        with open(record_txt, 'a', encoding='utf-8') as rt:
            print_string = f"electionday-{i}：line_num_before: {line_num_before}\t\tline_num_after: {line_num_after}\n"
...
if __name__ == "__main__":
    ...
    print("=====================================================================================================")
    output_folder = f'H:\\tranforming_relationship\\electionday_count'
    # 检查文件夹是否存在
