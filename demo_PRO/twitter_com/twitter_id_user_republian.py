...
def batch_extract_id_user(num_file, num_xlsx):
    record_txt = f'H:\\twitter_id_user\\republican\\{num_file}\\{num_file}.txt'
    ...
    for i in range(0, num_xlsx + 1):  # 生成0_output.xlsx-num_output.xslx
        ...
        output_xlsx = f'H:\\twitter_id_user\\republican\\{num_file}\\{num_file}-{i}.xlsx'
        print("-----------------------------------------------------------------------------------------------------")
        print(input_xlsx)
        print(output_xlsx)
        print(record_txt)
        ...
        with open(record_txt, 'a', encoding='utf-8') as rt:
            print_string = f"republican-{num_file}-{i}：line_count: {line_count}\t\turl_count: {url_count}\t\tline_num: {line_num}\n"
...
if __name__ == "__main__":
    ...
    for i in range(3, 7):
        ...
        print("=====================================================================================================")
        output_folder = f'H:\\twitter_id_user\\republican\\{i}'
        # 检查文件夹是否存在
