...
def batch_url_count(num_file, num_xlsx):
    ...
    record_txt = f'H:\\url_statistics\\republican\\{num_file}\\{num_file}.txt'
    ...
    for i in range(0, num_xlsx + 1):  # 生成0_output.xlsx-num_output.xslx
        ...
        output_xlsx = f'H:\\url_statistics\\republican\\{num_file}\\{num_file}-{i}.xlsx'
        print("-----------------------------------------------------------------------------------------------------")
        print(input_xlsx)
        print(output_xlsx)
        print(record_txt)
        ...
        with open(record_txt, 'a', encoding='utf-8') as rt:
            print_string = f"republican-{num_file}-{i}：all_none_num: {all_none_num}\t\tretweet_num: {retweet_num}\t\tquote_num: {quote_num}\t\tall_no_none_num: {all_no_none_num}\t\tall_no_none_index: {all_no_none_index}\n"
...
if __name__ == "__main__":
    ...
    for i in range(3, 7):
        ...
        print("=====================================================================================================")
        output_folder = f'H:\\url_statistics\\republican\\{i}'
        # 检查文件夹是否存在
